 ...
 * @author JONATHAN
 */
public class Archivo_Jalar_Pegar
{
     ...
     *
     * @param componente_a_jalar Component on which files will be dropped.
     * @param jalar_arrastrar Listens for <tt>filesDropped</tt>.
     * @since 1.0
     */
    //Este jala archivos
    public Archivo_Jalar_Pegar(
    final java.awt.Component componente_a_jalar,
    final Ejecutador jalar_arrastrar )
    {   this( null,  // Logging stream
              componente_a_jalar,     // Drop target
    ...
    final Ejecutador listener)
    {
System.out.println("Ejecutando Jalar y arrastrar");
        if( supportsDnD() )
...
/* ********  I N N E R   I N T E R F A C E   L I S T E N E R  ******** */
     ...
     * @since 1.1
     */
    public static interface Ejecutador {
...
/* ********  I N N E R   C L A S S  ******** */
    ...
    public static class TransferableObject implements java.awt.datatransfer.Transferable
    {
        ...
        public final static java.awt.datatransfer.DataFlavor DATA_FLAVOR =
            new java.awt.datatransfer.DataFlavor( Archivo_Jalar_Pegar.TransferableObject.class, MIME_TYPE );
